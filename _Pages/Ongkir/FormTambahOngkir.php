<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control" id="provinsi" name="provinsi" list="ListProvinsi" required>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control" id="kabupaten" name="kabupaten" list="ListKabupaten" required>
...
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control" id="kecamatan" name="kecamatan" list="ListKecamatan" required>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control" id="desa" name="desa" list="ListDesa" required>
...
<div class="row">
    <div class="col-md-12 mb-3">
        <div id="NotifikasiTambahOngkir">
            <span class="text-primary">Pastikan data ongkir yang anda input sudah benar</span>
        </div>
    </div>
</div>